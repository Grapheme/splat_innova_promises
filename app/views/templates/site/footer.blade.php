    ...
    <div class="wrapper">
        ...
        <div class="footer-block">
            <ul class="footer-links">
                <li>
                    <a href="{{URL::to('/how-it-works')}}">Как это работает</a>
                </li>
                <li>
                ...
                <div data-type="auth" class="form-inputs">
                    ...
                    <form action="{{ URL::route('app.email-pass-auth') }}" method="POST" class="reg_form_validate">
                        ...
                        <div class="btns">
                            ...
                            <a href="{{ URL::route('app.restore_password') }}" class="right-link js-change-box" data-box="auth">У меня уже есть аккаунт!</a>
                        </div>
                    </form>
        ...
        <div class="overlay__pop">
            ...
            <div class="pop-top">
                ...
                <div class="pop__share">
                    <ul class="soc-links">
                        <li>
                            <a target="_blank" onclick="ga('send', 'event', 'like', 'facebook');" href="http://www.facebook.com/sharer.php?u={{ $url }}" class="soc-icon"><i class="fi icon-fb"></i></a>
                        </li>
                        <li>
                            <a target="_blank" onclick="ga('send', 'event', 'like', 'vkontakte');" href="http://vk.com/share.php?url={{ $url }}&amp;event=button_share" class="soc-icon"><i class="fi icon-vk"></i></a>
                        </li>
                        <li>
                            <a target="_blank" onclick="ga('send', 'event', 'like', 'odnoklassniki');" href="http://www.odnoklassniki.ru/dk?st.cmd=addShare&amp;st._surl={{ $url }}" class="soc-icon"><i class="fi icon-ok"></i></a>
                        </li>
                    </ul>
                </div>
            </div>

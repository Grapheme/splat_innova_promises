      ...
      <div class="main-screen">
        <div class="main-fotorama">
          <div class="js-main-fotorama">
            <img src="{{ Config::get('site.theme_path') }}/images/main_slider/1new.jpg" alt="">
            <img src="{{ Config::get('site.theme_path') }}/images/main_slider/2new.jpg" alt="">
            <img src="{{ Config::get('site.theme_path') }}/images/main_slider/3new.jpg" alt="">
            <img src="{{ Config::get('site.theme_path') }}/images/main_slider/4new.jpg" alt="">
            <img src="{{ Config::get('site.theme_path') }}/images/main_slider/5new.jpg" alt="">
            <img src="{{ Config::get('site.theme_path') }}/images/main_slider/6new.jpg" alt="">
        ...
        <div class="main-content wrapper">
          ...
          <div class="input-cont js-promise-placeholder">
            ...
            <a class="hiw-link" href="{{URL::to('/how-it-works')}}">Как это работает?</a>
          </div>
        </div>
      </div>
